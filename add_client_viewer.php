...
if (isset($_POST['submit'])) {
   ...
   $client_recorded = $_POST['client_recorded_by'];
   ...
   if ($rowcount > 0) {
      ...
      if ($password == $repeatpsw) {
         ...
         $register_query = "INSERT INTO client_register(client_name,client_email,client_contact_Tel1,client_contact_Tel2, client_contact_person_1,client_contact_person_2,client_contact_Fax1,client_contact_Fax2,client_address,remarks,
    client_recorded_by,password) VALUES(:name,:email,:Tel1,:Tel2,:contact_person_1,:contact_person_2,:Fax1,:Fax2,:address,:remarks,
    :client_recorded,:hash)";
    $error="";
         try {
...
<body>
    ...
    <div class="wrapper">
     ...
     <form method="post" action="add_client_viewer.php">
     
            <div class="row my-row">
                <div class="col my-col col-lg-6 col-md-8">
                    <h3> Add Client Viewer</h3>
                </div>
            </div>
            <div class="row my-row">
                <div class="col my-col col-lg-6 col-md-8">
                    ...
                    <input type="text" class="form-control" placeholder="Enter client name" name="client_name" required autocomplete="off" autofocus>
                </div>
            </div>
            </div>
            <div class="row my-row">
                <div class="col my-col col-lg-6 col-md-8">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Client Address" name="client_address"
            ...
            <div class="row my-row">
                ...
                <div class="col my-col col-lg-3 col-md-4">
                    ...
                    <input type="password" class="form-control" placeholder="Please enter your password again"
            ...
            <div class="row my-row">
                <div class="col my-col col-lg-3 col-md-4">
                    ...
                    <input class="form-control" type="text" placeholder="Client Contact Tel1"
                ...
                <div class="col my-col col-lg-3 col-md-4">
                    ...
                    <input class="form-control" type="text" placeholder="Client Contact Tel2"
            ...
            <div class="row my-row">
                <div class="col my-col col-lg-6 col-md-8">
                    ...
                    <input type="text" class="form-control" placeholder="Client Recorded by?" name="client_recorded_by"
                        required autocomplete="off">
                </div>
                </div>
            </div>
