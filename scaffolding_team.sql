...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 24, 2019 at 01:09 AM
...
(8, 'Client Admin', 'asdhfp npiosd', 'Sdfadf', 'asdfwef', 12564, 458654, 3216464, 48799, 'clientadmin@scaff.com', 1, 'asdfwe daf wee df', '$2y$10$tuB023l30xI1sWPgvIhduexI0tjCIdwXUVDNGVhCfFf.6MzXfp3lG', 'CA', '2019-11-04 19:33:27', 1);
...
CREATE TABLE `quotation_register` (
  ...
  `system_user_aprooved` int(11) NOT NULL,
